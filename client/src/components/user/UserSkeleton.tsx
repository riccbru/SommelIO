      ...
      <View style={styles.profileHeader}>
        ...
        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "center" }}>
          ...
          <SkeletonPlaceholder
            ...
            highlightColor={theme.colors.card}
          >
            <View style={{ width: 28, height: 28, borderRadius: 50, marginLeft: 5, marginBottom: 8 }} />
          </SkeletonPlaceholder>
        </View>
        ...
        <View style={styles.statsView}>
          ...
          <View style={styles.statItem}>
            ...
            <Text style={styles.statLabel}>{t("profile.tastings.favorite").replace(" ", "\n")}</Text>
          </View>
          ...
          <View style={styles.statItem}>
            ...
            <Text style={styles.statLabel}>{t("profile.tastings.total").replace(" ", "\n")}</Text>
          </View>
          ...
          <View style={styles.statItem}>
            ...
            <Text style={styles.statLabel}>{t("profile.tastings.rated").replace(" ", "\n")}</Text>
          </View>
